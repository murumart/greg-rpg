...
func _on_tarikas_inspected() -> void:
	...
	while true:
		...
		if choice == &"bye":
			...
			dlg.al("...but why did she show up now...")
			dlg.al("...you saw... huh?")
			dlg.al("you saw [color=0f0]something[/color] there?")
			dlg.al("...is that so...")
			await dlg.speak_choice()
			...
			_mention("flowerboy")
			dlg.al('"flower boy".')
			dlg.al("this is no-one's name, but i know whom you mean...")
			dlg.al("i don't know much... about him.")
			dlg.al("he doesn't talk to us at all.")
			dlg.al("...or show up in town, ever.")
			dlg.al("what did he... tell you?")
			dlg.al("...")
			dlg.al("paths...")
			dlg.al("i wish i could say... that's nonsense.")
			dlg.al("...")
			await dlg.speak_choice()
		elif choice == &"mayor":
			dlg.reset()
			...
			dlg.al("ever since the town was... closed.")
			dlg.al("...but his antics have been fun to watch...")
			dlg.al("...window to the \"spirit world\"?")
			dlg.al("...did he... really...?")
			dlg.al("...what this town is... its isolation... it weighed on him.")
			dlg.al("he became something of a joke...")
			dlg.al("...and even once he does something... drastic...")
			dlg.al("he's just swept aside...")
			dlg.al("...you did see [color=0f0]it[/color], didn't you...")
			dlg.al("i think... he was caught at an... opportune moment.")
			dlg.al("what you're doing... is providing access.")
			await dlg.speak_choice()
		elif choice == &"flowers":
			dlg.reset()
			_mention("flowers")
			...
			if flowers_c < 2:
				...
				dlg.al("...be careful to not let this grow... over your head.")
				dlg.al("...")
			elif flowers_c < 5:
				dlg.al("growth...")
				...
				if DAT.get_data("heard_warstory", false):
				...
				if DAT.get_data("heard_warstory", false):
					...
					dlg.al("mh. truth be told, it wasn't... mine.")
					dlg.al("i was the leader of a... cleanup initiative.")
					dlg.al("the \"fallout\" after the war... reached wide.")
					dlg.al("wreckage... ruined towns and cities.")
					dlg.al("links to mana completely depleted in places...")
					dlg.al("we were mobilised on the very day after they reached him.")
					dlg.al("and in his chamber... lied...")
					dlg.al("beside what remnants his dying organism produced...")
					dlg.al("a [color=%s]flower[/color]." % dlg.FLOWERCOLOR)
					dlg.al("it hasn't aged a day after i found it.")
					dlg.al("it's beautiful... isn't it? and familiar.")
					dlg.al("why i'm here... finding the source of these [color=%s]flowers[/color]..." % dlg.FLOWERCOLOR)
					dlg.al("mh. let's say i got quite 'into it'.")
					dlg.al("after our mission, i found... others.")
					dlg.al("people... whispered niceties and given... guidance.")
					dlg.al("and those people... grew.")
					dlg.al("their share of the decisions made in the world... grew.")
					dlg.al("their effect on... the world grew.")
					dlg.al("mh...")
					dlg.al("there was 'someone' or 'something' doing this.")
					dlg.al("distributing them. distributing power.")
					dlg.al("was it a spirit? spirits themselves... disagree.")
					dlg.al("when this town went on lockdown...")
					dlg.al("i joined willingly. i figured i'd get closer to the cause...")
					dlg.al("everyone... related... to him... in any way... is here.")
					dlg.al("...it got closer to me.")
					dlg.al("there's no records of the flower shop ever opening.")
					dlg.al("but that's the 'old florist'.")
					dlg.al("we all know her shop... we all know her as a neighbor.")
					dlg.al("...well.")
					dlg.al("there's nothing left for me to do.")
					dlg.al("hasn't been... ever since i realised the state of affairs.")
					dlg.al("all i can do... is participate in this scheme of you two.")
				else:
					dlg.al("maybe this is of some interest... to you?")
...
func _what_now(dlg: DialogueBuilder) -> void:
	...
	if greg.level < 5:
		...
		if not DAT.get_data("president_fought", false):
			...
			dlg.al("there is someone in the store...")
		else:
		...
		if not cokay:
			...
			dlg.al("there's a path to there around north of town.")
			dlg.al("i always just follow... the bird.")
		...
		if not "town_east" in DAT.get_data("visited_rooms"):
			...
			dlg.al("could always ask them.... about it.")
		else:
