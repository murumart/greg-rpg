...
func dialogue() -> void:
	...
	match d_progress:
		...
		3: dlg.add_line(dlg.ml("giving me the [color=%s]flower[/color] was a mistake, too." % FLOWERCOLOR))
		...
		11:
			...
			dlg.add_line(dlg.ml("i reject my [color=%s]flower[/color]!" % FLOWERCOLOR).stext_speed(0.8))
