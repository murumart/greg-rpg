...
const COMPLETED_GAME := {
	...
	"fish_fought": true,
	"president_fought": true,
	"sun_spirit_fought": true,
	"heard_warstory": true,
	"is_it_known_that_greg_fulfilled_bounty_thugs": true,
	"is_it_known_that_greg_fulfilled_bounty_stray_animals": true,
	"is_it_known_that_greg_fulfilled_bounty_broken_fishermen": true,
